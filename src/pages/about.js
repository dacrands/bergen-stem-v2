    ...
    <div className="container">
      ...
      <div className="card">
        ...
        <div className="card__content">
          <h3>Resources</h3>
          <p>
            Majoring in STEM is a difficult task, so be sure to utilize
              our  <a href="https://bergen.edu/wp-content/uploads/Running-Start-Program-Poster-With-Link-1.pdf" target="_blank" rel="noopener noreferrer">free prep classes</a> and
            award-winning tutoring services to get the
                            </p>
        </div>
      </div>
